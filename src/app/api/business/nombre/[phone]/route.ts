// app/api/business/nombre/[phone]/route.ts
...
/* ============================================================
   GET → Obtener el nombre del negocio
   ============================================================ */
export async function GET(
  ...
  try {
    ...
    console.error("❌ Error GET /business/nombre/[phone]:", error);
    return NextResponse.json(
      { error: "Error interno al obtener el nombre del negocio." },
      { status: 500 }
    );
  }
}
...
/* ============================================================
   PATCH → Actualizar el nombre del negocio
   Body esperado:
   {
...
export async function PATCH(
  ...
  try {
    ...
    if (!body || typeof body.nombre !== "string") {
      return NextResponse.json(
        { error: "Debes enviar un campo 'nombre' de tipo string." },
        { status: 400 }
      );
    }
    ...
    console.error("❌ Error PATCH /business/nombre/[phone]:", error);
    return NextResponse.json(
      { error: "Error interno al actualizar el nombre." },
      { status: 500 }
    );
  }
}

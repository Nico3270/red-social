      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        {backgroundProducts.map((p, i) => {
          const backgroundImageUrl =
            p.imagenes.find(isRenderableImageSource) || PLACEHOLDER_PRODUCT_IMAGE;
          const optimizedBackgroundImageUrl = getCloudinaryImageUrl(
            backgroundImageUrl,
            "thumbnail",
          );
          ...
          return (
            ...
            >
              <Image
                src={optimizedBackgroundImageUrl}
                alt={p.nombre}
                fill
      ...
      <div className="relative z-10 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-5 px-2 sm:px-4">
        {teasers.map((producto, index) => {
          const productImageUrl =
            producto.imagenes.find(isRenderableImageSource) || PLACEHOLDER_PRODUCT_IMAGE;
